"""Tests for the public gilcheck API."""
...
import gilcheck
from gilcheck import __all__, __version__, add
...
class TestPackageMetadata:
    ...
    def test_version_matches_installed_metadata(self):
        assert __version__ == version("gilcheck")
    ...
    def test_version_falls_back_when_package_not_installed(self, monkeypatch):
        ...
        with monkeypatch.context() as patched:
            ...
            reloaded = importlib.reload(gilcheck)

        assert reloaded.__version__ == "0.0.0+unknown"
        importlib.reload(gilcheck)
