...
- `scripts/bootstrap.py` deterministic template initializer: renames the
  package and replaces every placeholder (`gilcheck`, `gilcheck`,
...
- Simplified `src/gilcheck/__init__.py`'s version resolution to the
...
[Unreleased]: https://github.com/tomada1114/gilcheck/commits/main
